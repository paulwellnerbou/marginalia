...
// Language registry is code-split — each `import('shiki/dist/langs/X.mjs')`
// becomes its own chunk, lazy-loaded on first use. Adding a language here
// doesn't grow the initial bundle, so err on the side of inclusive.
