...
function instructions(config: McpConfig): string {
  return [
    ...
    '     text comes from.',
    '  3. create_proposal — suggest the concrete rewrite, with `answers_thread_id` set to',
    '     the comment you are answering. That records a real link: the reviewer sees',
    '     "See proposed change" on their comment, and accepting the proposal resolves it.',
