...
export function AssetsPanel({
  ...
  return (
    <aside className={`assets-panel ${open ? 'open' : 'closed'}`} aria-label="Document assets">
      <div className="assets-panel__header pane-header">
        <IconButton
          variant="ghost"
          size="1"
          onClick={onToggle}
          title={open ? 'Collapse assets' : 'Expand assets'}
      ...
      {open && (
        <div className="assets-panel__body">
          {sorted.length === 0 ? (
